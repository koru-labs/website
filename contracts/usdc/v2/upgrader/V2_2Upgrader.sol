...
contract V2_2Upgrader is AbstractV2Upgrader {
  ...
  function upgrade() external onlyOwner {
    ...
    // Test transfer
    require(
      v2_2.transfer(msg.sender, 1e5) && v2_2.balanceOf(msg.sender) == callerBal + 1e5 && v2_2.balanceOf(address(this)) == contractBal - 1e5,
   ...
   */
  function checkFiatTokenMetadataEqual(FiatTokenMetadata memory a, FiatTokenMetadata memory b) private pure returns (bool) {
    return
